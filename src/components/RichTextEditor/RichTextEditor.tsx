...
.ql-snow .ql-toolbar .ql-picker-item.ql-selected {
  color: var(--F_Font_Color_Primary);
}
...
@media (pointer: coarse) {
  ...
  .ql-snow .ql-toolbar button:hover:not(.ql-active) .ql-stroke.ql-fill {
    fill: var(--F_Font_Color_Label);
  }
  .ql-snow.ql-toolbar button:hover:not(.ql-active) .ql-stroke,
  .ql-snow .ql-toolbar button:hover:not(.ql-active) .ql-stroke,
  .ql-snow.ql-toolbar button:hover:not(.ql-active) .ql-stroke-miter,
  .ql-snow .ql-toolbar button:hover:not(.ql-active) .ql-stroke-miter {
    stroke: var(--F_Font_Color_Label);
  }
}
.ql-snow {
  box-sizing: border-box;
...
.ql-snow .ql-editor blockquote {
  border-left: 4px solid var(--F_Font_Color_Label);
  margin-bottom: 5px;
  margin-top: 5px;
  padding-left: 16px;
}
...
.ql-toolbar.ql-snow .ql-picker.ql-expanded .ql-picker-label {
  border-color: var(--F_Font_Color_Label);
}
...
.ql-snow .ql-tooltip a.ql-action::after {
  border-right: 1px solid var(--F_Font_Color_Label);
  content: 'Edit';
  margin-left: 16px;
  padding-right: 8px;
}
